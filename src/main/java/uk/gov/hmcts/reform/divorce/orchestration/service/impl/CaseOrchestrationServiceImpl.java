...
public class CaseOrchestrationServiceImpl implements CaseOrchestrationService {
    ...
    public Map<String, Object> updateDNPronouncedCases() throws WorkflowException {
        log.info("Starting update of DN pronounced cases");
        Map<String, Object> result = updateDNPronouncedCasesWorkflow.run(authUtil.getCaseworkerToken());
        log.info("Update of DN pronounced cases completed");
        return result;
    }
