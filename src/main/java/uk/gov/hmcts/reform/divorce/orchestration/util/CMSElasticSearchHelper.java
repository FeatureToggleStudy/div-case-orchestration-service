...
@Slf4j
@Component
public class CMSElasticSearchHelper {

    private final CaseMaintenanceClient caseMaintenanceClient;

    @Autowired
    public CMSElasticSearchHelper(CaseMaintenanceClient caseMaintenanceClient) {
    ...
    public Stream<CaseDetails> searchCMSCases(int start, int pageSize, String authToken, QueryBuilder... builders) {
        ...
        return finalResult.getCases().stream();//TODO - could replace finalResult with stream builder
    }
