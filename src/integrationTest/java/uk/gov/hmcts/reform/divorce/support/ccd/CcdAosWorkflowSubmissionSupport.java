...
public abstract class CcdAosWorkflowSubmissionSupport extends IntegrationTest {
    ...
    protected String getSubmissionRequestUrl() {
        return cmsServerUrl + contextPath;
    }

    protected Map<String, Object> getHeaders() {
        return getHeaders(getUserToken(true));
    }

    public Map<String, Object> getHeaders(String userToken) {
