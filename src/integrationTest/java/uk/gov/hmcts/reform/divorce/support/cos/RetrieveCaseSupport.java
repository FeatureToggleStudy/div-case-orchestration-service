...
public abstract class RetrieveCaseSupport extends IntegrationTest {

    protected static final String RETRIEVED_DATA_COURT_ID_KEY = "data.courts";

    @Value("${case.orchestration.retrieve-case.context-path}")
    private String retrieveCaseContextPath;//TODO - create another abstract class, like the AOS case support one?
    ...
    }//TODO - common place? - maybe already be in my other PR
